...
from PyQt5.Qt3DRender import QGeometryRenderer, QTexture2D, QTextureLoader
...
class World3D():
    ...
    def setLatitude(self, latitude):
        ...
        if self.latitude < 0.0:
            self.skyTransform.setRotationZ(90.0 - abs(self.latitude))
        else:
            self.skyTransform.setRotationZ(-(90.0 - self.latitude))
